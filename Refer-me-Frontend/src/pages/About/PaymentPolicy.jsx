...
const PaymentPolicy = () => {
  return (
    <>
      ...
      <SEOManagement
        title="Payment Policy | Refer Me Group"
        description="Read Refer Me Group’s transparent payment policy for courses, services, and programs."
        keywords="payment policy, Refer Me Group payments, course payment terms"
        canonical="/about/paymentpolicy"
      />
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <div className="space-y-4 text-gray-600">
                    <p>
                      Our refund and returns policy lasts 1 or 2 days. If 2 days
                      have passed since your purchase, we can't offer you a full
                      refund or exchange.
                    </p>
                    <p>
            ...
            <section className="group">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <div className="space-y-4 text-gray-600">
                    <p>
                      Once your return is received and inspected, we will email
                      you about receipt of your returned item and notify you of
                      the approval or rejection of your refund.
                    </p>
                    <p>
                      If approved, your refund will be processed and credited to
                      your original payment method within a certain number of
                      days.
                    </p>
                  </div>
                </div>
                ...
                <div className="ml-4">
                  ...
                  <div className="space-y-4 text-gray-600">
                    ...
                    <ol className="list-decimal pl-5 space-y-2 marker:font-medium marker:text-indigo-500">
                      ...
                      <li>
                        Contact your credit card company (processing time may be
                        required)
                      </li>
                      <li>
                ...
                <div className="ml-4">
                  ...
                  <div className="space-y-4 text-gray-600">
                    <p>
                      ...
                      you need to exchange for the same item, email us at{" "}
                      <a
                        href="mailto:contact@refermegroup.com"
                        className="text-indigo-600 hover:underline"
                      >
                ...
                <div className="ml-4">
                  ...
                  <div className="space-y-4 text-gray-600">
                    <p>
                      ...
                      the value of your return. Once received, a gift
                      certificate will be mailed to you.
                    </p>
                    <p>
                      If not marked as a gift or shipped to the gift giver
                      first, we will refund the gift giver who will be notified
                      of your return.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">
                    ...
                    for questions about refunds and returns.
                  </p>
                </div>
              </div>
            </section>
