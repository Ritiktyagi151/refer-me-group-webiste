...
const Career = () => {
  ...
  return (
    <>
      ...
      <SEOManagement
        title="Official Career | Refer Me Group Insights"
              ...
              <div className="grid gap-6 md:grid-cols-3">
                ...
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="text-gray-600">
                    Get notified about job openings before they're publicly
                    posted{" "}
                  </p>{" "}
                </div>{" "}
                <div className="border-l-4 border-green-500 pl-4">
                  ...
                  <p className="text-gray-600">
                    Access resume tips, interview questions, and industry
                    insights{" "}
                  </p>{" "}
                </div>{" "}
