  ...
  return (
    <section className="bg-white py-12 md:py-2 flex justify-between items-start w-full px-8 gap-6 flex-wrap lg:flex-nowrap overflow-hidden">
      <div className="flex flex-col justify-start items-start w-full lg:w-[45%] py-10">
        <h2 className="text-[20px] uppercase font-semibold text-blue-600">
          Refer Me Group
        </h2>
        <p className="text-[30px] font-bold leading-tight text-gray-800 py-2 uppercase">
        ...
        <p className="py-5 text-gray-600">
          Refer Me Group is a forward-thinking professional training and
          development platform committed to bridging skill gaps and empowering
          individuals to thrive in today’s global job market. Our goal is to
          deliver high-impact learning through innovative, hands-on, and
          industry-relevant training programs across technology, management, and
          business domains.
          <br />
          Founded by a team of passionate entrepreneurs, Refer Me Group was born
          out of the need to create a smarter, more effective pathway for
          professionals to upskill. Our programs are led by seasoned industry
          experts who bring real-world knowledge into every session — inspiring
          learners to meet career challenges with confidence.
        </p>
        ...
        <div className="w-1/2 transform -skew-x-0 overflow-hidden">
          ...
          >
            {images.map((item, index) => (
              <SwiperSlide
                key={index}
                className="!flex !justify-center !py-0 !my-0"
              >
                <img
                  src={item}
                  alt={`Slide ${index + 1}`}
