...
router.post("/payu", (req, res) => {
  ...
  const params = {
    ...
    email,
    phone,
    surl: "https://72.60.101.229:5000/api/payment/success", // Local success URL (test ke liye)
    furl: "https://72.60.101.229:5000/api/payment/fail", // Local failure URL (test ke liye)
    hash,
